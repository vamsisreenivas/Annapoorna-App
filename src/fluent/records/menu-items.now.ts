...
export const dosa_plain = Record({
    ...
    data: {
        ...
        image_url: 'https://source.unsplash.com/featured/800x600/?plain%20dosa,south%20indian%20food',
...
export const masala_dosa = Record({
    ...
    data: {
        ...
        image_url: 'https://source.unsplash.com/featured/800x600/?masala%20dosa,south%20indian%20food',
        category: 'main_course',
        price: 10.99,
        available: true,
        preparation_time: 20,
...
export const sambar_vada = Record({
    ...
    data: {
        ...
        image_url: 'https://source.unsplash.com/featured/800x600/?medu%20vada,sambar',
        category: 'appetizer',
        price: 6.99,
        available: true,
        preparation_time: 10,
...
export const idli_sambar = Record({
    ...
    data: {
        ...
        image_url: 'https://source.unsplash.com/featured/800x600/?idli,sambar,south%20indian%20food',
        category: 'main_course',
        price: 7.99,
        available: true,
        preparation_time: 12,
...
export const filter_coffee = Record({
    ...
    data: {
        ...
        image_url: 'https://source.unsplash.com/featured/800x600/?south%20indian%20filter%20coffee',
        category: 'beverage',
        price: 3.99,
        available: true,
        preparation_time: 5,
...
export const curd_rice = Record({
    ...
    data: {
        ...
        image_url: 'https://source.unsplash.com/featured/800x600/?curd%20rice,indian%20food',
        category: 'main_course',
        price: 6.99,
        available: true,
        preparation_time: 15,
...
export const rasam = Record({
    ...
    data: {
        ...
        image_url: 'https://source.unsplash.com/featured/800x600/?rasam,south%20indian%20soup',
        category: 'appetizer',
        price: 4.99,
        available: true,
        preparation_time: 8,
...
export const payasam = Record({
    ...
    data: {
        ...
        image_url: 'https://source.unsplash.com/featured/800x600/?payasam,kheer,indian%20dessert',
        category: 'dessert',
        price: 5.99,
        available: true,
        preparation_time: 30,
...
export const buttermilk = Record({
    ...
    data: {
        ...
        image_url: 'https://source.unsplash.com/featured/800x600/?spiced%20buttermilk,chaas,indian%20drink',
        category: 'beverage',
        price: 2.99,
        available: true,
        preparation_time: 5,
...
export const chicken_curry = Record({
    ...
    data: {
        ...
        image_url: 'https://source.unsplash.com/featured/800x600/?south%20indian%20chicken%20curry',
        category: 'main_course',
        price: 14.99,
        available: true,
        preparation_time: 25,
...
export const rava_upma = Record({
    ...
    data: {
        ...
        image_url: 'https://source.unsplash.com/featured/800x600/?rava%20upma,upma,indian%20breakfast',
        category: 'main_course',
        price: 5.99,
        available: true,
        preparation_time: 18,
...
export const mysore_pak = Record({
    ...
    data: {
        ...
        image_url: 'https://source.unsplash.com/featured/800x600/?mysore%20pak,indian%20sweet',
        category: 'dessert',
        price: 4.99,
        available: true,
        preparation_time: 25,
...
export const coconut_chutney = Record({
    ...
    data: {
        ...
        image_url: 'https://source.unsplash.com/featured/800x600/?coconut%20chutney,indian%20condiment',
        category: 'appetizer',
        price: 3.99,
        available: true,
        preparation_time: 8,
